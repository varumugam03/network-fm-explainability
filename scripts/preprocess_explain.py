...
if len(remaining_indices) == 0:
    ...
    for i in tqdm(range(0, len(remaining_indices), BATCH_SIZE)):
        ...
        for idx in batch_indices:
            ...
            prompt = dedent(
                f"""You are a cybersecurity analyst. Your task is to explain why the following network flow is labeled as a {label} attack. This flow is part of the CIC-IDS2018 dataset, which includes realistic attack scenarios and benign behavior.
            ...
            ### INSTRUCTIONS
            Use ONLY the flow features provided below to construct your explanation. Do NOT include any of the auxilliary information, using it only for context.
